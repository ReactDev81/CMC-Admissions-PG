    ...
    return(
        <footer className="bg-white-default w-full">
            <div className={`w-full flex flex-wrap items-center justify-between py-4 px-5 ${className}`}>
                <div className="font-medium text-black-300">Copyright 2025 © <Link className="text-primary-default underline" to="https://www.cmcludhiana.in">cmcludhiana.in</Link></div>
