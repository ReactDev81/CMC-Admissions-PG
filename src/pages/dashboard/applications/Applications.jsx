            ...
            <div className="bg-white-default py-5 rounded-lg">
                ...
                <table className="table w-full">
                    <thead className="bg-primary-100 text-black-default">
                        <tr>
                            <th className="text-left py-3 px-4 text-base font-medium text-black-default leading-5">
                                Name
                            </th>
                            <th className="text-left py-3 px-4 text-base font-medium text-black-default leading-5">
                                Application No.
                    ...
                    <tbody>
                        {
                            StudenList && StudenList.map((Student, index) => {
                                return(
                                    <tr key={index} className="bg-white-default text-black-default text-left border-b">
                                        <td className="px-5 py-3.5">
                                            <div className="flex items-center gap-2.5">
                                                <img src={Student.image} className="h-10 w-10 rounded-full object-cover" alt="" /><span>{Student.name}</span>
                                            </div>
                                        </td>
                                        <td className="px-5 py-3.5">
                                            <p className="text-info-default">{Student.application_no}</p>
                                        </td>
                                        <td className="px-5 py-3.5">
                                            <p className="text-black-300">{Student.email}</p>
                                        </td>
                                        <td className="px-5 py-3.5">
                                            <p className="text-black-300">{Student.mobile}</p>
                                        </td>
                                        <td className="px-5 py-3.5">
                                            <p className="text-black-300">{Student.applied}</p>
                                        </td>
                                        <td className="px-5 py-3.5">
                                            <p className="text-black-300">{Student.created_at}</p>
                                        </td>
                                        <td className="px-5 py-3.5">
                                            <p className="text-black-300">{Student.submission_date}</p>
                                        </td>
                                        <td className="px-5 py-3.5">
